 ...
 const handlePatientSelection = async()=>{
  ...
  if (step === "choose-role") {
     return (<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <Card  onClick={() => !loading && handlePatientSelection()}
      className="border-emerald-900/20 hover:border-emerald-700/40 cursor-pointer transition-all">
        <CardContent className="pt-6 pb-6 flex flex-col items-center text-center">
          ...
          <CardDescription className="mb-4"> Book appointments , consult with doctors and manages your healthcare journey </CardDescription> 
          <Button  className="w-full mt-2 bg-emerald-400 hover:bg-emerald-400  " disabled={loading}>
           {loading ? (
                <>
      ...
      className="border-emerald-900/20 hover:border-emerald-700/40 cursor-pointer transition-all">
        <CardContent className="pt-6 pb-6 flex flex-col items-center text-center">
          ...
          <Button disabled = {loading}
           className="w-full mt-2 bg-emerald-400 hover:bg-emerald-400">
